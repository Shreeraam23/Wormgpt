...
# Bot Configuration
BOT_TOKEN = os.getenv("8071095750:AAE8N--TqGlgD4VvpngAf9ni45LDBzjWLSM")
if not BOT_TOKEN:
    raise ValueError("BOT_TOKEN environment variable is required")

ADMIN_CHAT_ID = int(os.getenv("7968732891", "7968732891"))

# Channels to join
REQUIRED_CHANNELS = [
    {"name": "rajputserver", "url": "https://t.me/rajputserver", "chat_id": "@rajputserver"},
]

# Developer info
DEVELOPER_USERNAME = "@rajputserver"
